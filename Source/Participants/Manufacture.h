...
protected:
	...
	std::map<const product, std::pair<int, int> > production;
	...
	std::map<const product, std::pair<int, int> > consumtion;	

public:
	Manufacture(std::map<const product, std::pair<int, int> > production, std::map<const product, std::pair<int, int> > consumtion, const int money);
	~Manufacture();
	bool update();
